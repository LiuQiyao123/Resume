  ...
  loadResumeData: function (resumeId) {
    ...
    const mockResumeData = {
      ...
      basicInfo: {
        ...
        location: '北京',
        position: '高级前端开发工程师',
        summary: '5年前端开发经验，精通 Vue、React 等主流框架，对前端工程化和性能优化有深入研究。'
      },
      education: [
        {
          school: '北京大学',
          ...
          startDate: '2015-09',
          endDate: '2019-06',
          description: '主修课程：数据结构、算法设计、计算机网络、操作系统等'
        }
      ],
      experience: [
        {
          ...
          startDate: '2019-07',
          endDate: '至今',
          description: '负责公司核心产品的前端开发和维护工作'
        }
      ],
      projects: [
        {
          ...
          startDate: '2020-01',
          endDate: '2020-06',
          description: '使用 Vue3 + TypeScript 重构旧系统，提升了50%的性能'
        }
      ],
      skills: ['JavaScript', 'TypeScript', 'Vue', 'React', 'Node.js', 'Webpack']
    };
